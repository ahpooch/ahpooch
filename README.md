...
- [gaelcolas/Sampler](https://github.com/gaelcolas/Sampler) ([v0.119.0-preview0005](https://github.com/gaelcolas/Sampler/releases/tag/v0.119.0-preview0005), 5 days ago) - Module template with build pipeline and examples, including DSC elements.
- [ahpooch/PSMailKit](https://github.com/ahpooch/PSMailKit) ([v0.1.1](https://github.com/ahpooch/PSMailKit/releases/tag/v0.1.1), 6 days ago) - PSMailKit is a PowerShell module designed for secure and advanced email operations, replacing outdated cmdlets with modern, feature-rich alternatives. Built on the MailKit and MimeKit libraries, it ensures reliable SMTP communication with support for client certificates, authentication flexibility, and extended protocol capabilities.
