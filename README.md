...
- [ahpooch/AdventOfCode_PowerShell](https://github.com/ahpooch/AdventOfCode_PowerShell) - Solutions for https://adventofcode.com/ in PowerShell. (4 months ago)

#### 🚀 Latest releases I've contributed to

- [dsccommunity/DnsServerDsc](https://github.com/dsccommunity/DnsServerDsc) ([v3.0.2](https://github.com/dsccommunity/DnsServerDsc/releases/tag/v3.0.2), 6 days ago) - This module contains DSC resources for the management and configuration of Windows Server DNS Server.
