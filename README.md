...
- [gaelcolas/Sampler](https://github.com/gaelcolas/Sampler) ([v0.119.1](https://github.com/gaelcolas/Sampler/releases/tag/v0.119.1), 4 days ago) - Module template with build pipeline and examples, including DSC elements.
- [gethomepage/homepage](https://github.com/gethomepage/homepage) ([v1.9.0](https://github.com/gethomepage/homepage/releases/tag/v1.9.0), 2 weeks ago) - A highly customizable homepage (or startpage / application dashboard) with Docker and service API integrations.
