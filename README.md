...
- [gaelcolas/Sampler](https://github.com/gaelcolas/Sampler) ([v0.119.2-preview0001](https://github.com/gaelcolas/Sampler/releases/tag/v0.119.2-preview0001), today) - Module template with build pipeline and examples, including DSC elements.
- [gethomepage/homepage](https://github.com/gethomepage/homepage) ([v1.12.1](https://github.com/gethomepage/homepage/releases/tag/v1.12.1), 3 days ago) - A highly customizable homepage (or startpage / application dashboard) with Docker and service API integrations.
