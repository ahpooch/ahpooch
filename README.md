...
- [dsccommunity/DnsServerDsc](https://github.com/dsccommunity/DnsServerDsc) ([v3.0.1-preview0006](https://github.com/dsccommunity/DnsServerDsc/releases/tag/v3.0.1-preview0006), 2 days ago) - This module contains DSC resources for the management and configuration of Windows Server DNS Server.
