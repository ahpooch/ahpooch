...
- [gaelcolas/Sampler](https://github.com/gaelcolas/Sampler) ([v0.121.0-preview0001](https://github.com/gaelcolas/Sampler/releases/tag/v0.121.0-preview0001), 1 day ago) - Module template with build pipeline and examples, including DSC elements.
- [gethomepage/homepage](https://github.com/gethomepage/homepage) ([v2.2.0](https://github.com/gethomepage/homepage/releases/tag/v2.2.0), 2 days ago) - A highly customizable homepage (or startpage / application dashboard) with Docker and service API integrations.
