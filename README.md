...
- [dsccommunity/DnsServerDsc](https://github.com/dsccommunity/DnsServerDsc) - This module contains DSC resources for the management and configuration of Windows Server DNS Server. (10 months ago)

#### 🚀 Latest releases I've contributed to

- [gethomepage/homepage](https://github.com/gethomepage/homepage) ([v2.4.0](https://github.com/gethomepage/homepage/releases/tag/v2.4.0), 1 week ago) - A highly customizable homepage (or startpage / application dashboard) with Docker and service API integrations.
- [gaelcolas/Sampler](https://github.com/gaelcolas/Sampler) ([v0.121.0-preview0001](https://github.com/gaelcolas/Sampler/releases/tag/v0.121.0-preview0001), 3 weeks ago) - Module template with build pipeline and examples, including DSC elements.
